...
echo "<h3><i>Staff Advisor editing panel</h3></i>";
...
echo '</div><div class="cell">';
							...
							echo '</div><div class="cell">';
							echo $email;/////////////////////////////////
							echo '</div><div class="cell"><form action="staff.php" method="POST"><INPUT background-color="red" TYPE="TEXT" NAME="name'.$i.'" SIZE="12"></div><div class="cell"><INPUT TYPE="email" NAME="email'.$i.'" SIZE="20"></div></div>';
$i=$i+1;    }
